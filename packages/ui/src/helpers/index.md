...
Helpers 是无 UI 的纯工具集合，包含文本渲染、组件属性挂载、格式化和 easing 辅助函数。
...
<code src="./__fixtures__/examples/basic.tsx" title="工具集合" description="Helpers 是纯函数集合，不直接渲染可视组件。"></code>

## 引入

```tsx | pure
import { formatDate, formatNumber, renderTextLikeJSX } from '@ftsukic/react-native-ui'
```
