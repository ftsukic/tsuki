...
<code src="./__fixtures__/examples/basic.tsx" title="基础提示" description="showDialog 默认只展示确认按钮。"></code>

<code src="./__fixtures__/examples/confirm.tsx" title="确认框" description="showConfirmDialog 增加取消按钮并通过 Promise 区分结果。"></code>

<code src="./__fixtures__/examples/controlled.tsx" title="受控组件" description="使用 show 和 onShowChange 管理 Dialog 的显示状态。"></code>

<code src="./__fixtures__/examples/custom.tsx" title="自定义内容" description="使用 ReactNode 标题、children 正文和 footer 自定义底部。"></code>

<code src="./__fixtures__/examples/before-close.tsx" title="异步关闭" description="beforeClose 可以阻止关闭并在检查期间显示按钮 loading。"></code>

<code src="./__fixtures__/examples/round.tsx" title="圆角按钮" description="theme 为 round-button 时使用圆角操作按钮。"></code>

<code src="./__fixtures__/examples/interactions.tsx" title="遮罩与禁用" description="展示遮罩关闭和按钮禁用行为。"></code>

<code src="./__fixtures__/examples/theme.tsx" title="主题定制" description="通过 Dialog token 和 semantic styles 定制视觉。"></code>
