...
export function getPickerToken(token: AliasToken): PickerToken {
  return {
    ...
    picker_text_color: token.colorText,
    picker_disabled_text_color: token.colorTextDisabled,
    picker_toolbar_title_color: token.colorText,
    picker_cancel_button_color: token.colorTextSecondary,
    picker_confirm_button_color: token.colorPrimary,
    picker_disabled_option_opacity: 0.3,
    ...
    picker_toolbar_button_pressed_opacity: token.pressedOpacity,
    picker_border_width: token.lineWidth,
    picker_item_padding_horizontal: token.paddingXXS,
    picker_swipe_duration: 1000,
    picker_indicator_horizontal_inset: 16,
